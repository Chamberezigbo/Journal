...
<html lang="en" dir="ltr">
  ...
  <body>
          ...
          <form class="row g-3 d-block d-sm-none gig">
            ...
            <div class="col-12 mt-2">
              <div class="form-check">
                ...
                <label class="form-check-label" for="invalidCheck2" style="font-family:ibarrarealnova-variablefont;color:#034191;">
                  Remember me
                </label>
              </div>
            </div>
    ...
    <!-- login details -->
      <div class="container log-details d-none d-sm-block">
        <div class="row">
          <form class="row g-3 gi" id="form" action="login-inc.php" method="post" role="form">
            ...
            <div class="" >
              <a href="#"><button name="login" type="submit" class="btn btn-color " style="font-family:ibarrarealnova-variablefont;">Login</button></a>
            </div>
          </form>
        </div>
      </div>
