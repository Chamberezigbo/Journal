...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!-- user posts -->
      <div class="container user-post text-center">
        <div class="card text-centercard-line">
          <div class="card-header" style="font-family:ibarrarealnova-variablefont;">
            MAKE POST
          </div>
          <div class="card-body">
            <h5 class="card-title" style="font-family:ibarrarealnova-variablefont;">Click on the button below to make posts....</h5>
            <p class="card-text" style="font-family:ibarrarealnova-variablefont;">Posts made by you will be made public for other users to read...</p>
            <!-- <a href="#" class="btn btn-post">Make Post</a> -->
          ...
          <div class="card-footer text-muted" style="font-family:ibarrarealnova-variablefont;">
            Madonna University 1999 - 2022 &reg;
          </div>
        </div>
      </div>
    <!-- user posts end  -->
    ...
    <!-- bottom nav -->
      <nav class="nav d-sm-none fixed-bottom">
       ...
       <a href="login.html" class="nav__link"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="28" fill="currentColor" class="bi bi-box-arrow-in-right text-white" viewBox="0 0 16 16">
         ...
         <span class="nav__text text-white" style="font-family:ibarrarealnova-variablefont;font-weight:bold;">Logout</span>
       </a>
      </nav>
   <!-- bottom nav end -->
