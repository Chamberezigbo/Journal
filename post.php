...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="description" content="The Bazaar Store is an online best selling shirt store.">
  ...
  <body>
          ...
          <nav class="navbar navbar-expand-lg navbar-light nav-bg sticky">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left:-135px;">
              <ul class="navbar-nav mx-auto">
                ...
                <!-- <li class="nav-item">
                  <a class="nav-link ml-sm-3 text-dark font-weight-bold" style="font-size:20px;font-family:ibarrarealnova-variablefont;" href="about.html">About</a>
                </li> -->
                <li class="nav-item">
                  <a class="nav-link ml-sm-3 text-dark font-weight-bold" style="font-size:20px;font-family:ibarrarealnova-variablefont;" href="post.html">Posts</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
          <div class="col-sm-6">
            <h1 class="banner" style="font-family:ibarrarealnova-variablefont;">
              Online Madonna Computer Engineering Journal Review And Assessment Platform. Student Posts
            </h1>

          </div>
          <div class="col-sm-6">
            <img src="images/p.svg" class="img-fluid reivew-img" alt="">
          </div>
        </div>
      </div>
    <!-- post banner end -->
    ...
    <!-- card-post -->
      <div class="container card-top">
        <div class="row">
          <div class="col-sm-6">
            <div class="card card-line">
              <div class="card-header" style="font-family:ibarrarealnova-variablefont;">
                Chamberlain made a post 5 mintues ago
              </div>
              <div class="card-body">
                <h5 class="card-title" style="font-family:ibarrarealnova-variablefont;">Lorem</h5>
                <p class="card-text" style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel" style="font-family:ibarrarealnova-variablefont;">Chamberlain's Posts</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                         <p  style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
                        </div>
          ...
          <div class="col-sm-6 second-card">
            <div class="card card-line">
              <div class="card-header" style="font-family:ibarrarealnova-variablefont;">
                Charles made a post 5 mintues ago
              </div>
              <div class="card-body">
                <h5 class="card-title" style="font-family:ibarrarealnova-variablefont;">Lorem</h5>
                <p class="card-text" style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
                <!-- Button trigger modal -->
                  ...
                  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel" style="font-family:ibarrarealnova-variablefont;">Charles's Posts</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                         <p  style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
          ...
          <div class="col-sm-6 mt-5">
            <div class="card card-line">
              <div class="card-header" style="font-family:ibarrarealnova-variablefont;">
                Sandra made a post 5 mintues ago
              </div>
              <div class="card-body">
                <h5 class="card-title" style="font-family:ibarrarealnova-variablefont;">Lorem</h5>
                <p class="card-text" style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
                <!-- Button trigger modal -->
                  ...
                  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel" style="font-family:ibarrarealnova-variablefont;">Sandra's Posts</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                         <p  style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
          ...
          <div class="col-sm-6 second-card mt-5">
            <div class="card card-line">
              <div class="card-header" style="font-family:ibarrarealnova-variablefont;">
                Zaram made a post 5 mintues ago
              </div>
              <div class="card-body">
                <h5 class="card-title" style="font-family:ibarrarealnova-variablefont;">Lorem</h5>
                <p class="card-text" style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
                <!-- Button trigger modal -->
                  ...
                  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel" style="font-family:ibarrarealnova-variablefont;">Zaram's Posts</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                         <p  style="font-family:ibarrarealnova-variablefont;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in volupta</p>
    ...
    <!-- bottom nav -->
      <nav class="nav d-sm-none fixed-bottom">
       ...
       <a href="login.html" class="nav__link"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="28" fill="currentColor" class="bi bi-box-arrow-in-right text-white" viewBox="0 0 16 16">
