...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Madonna Computer Engineering Journal</title>
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="index.php">> <span>Default Dashboard</span></a>
                           </li>
                           <li>
                              <a href="index.php">> <span>Dashboard style 2</span></a>
                           </li>
                        </ul>
                     </li>
                                             ...
                                             <tbody>
                                                  <tr>
                                                       ...
                                                       <td>
                                                            ...
                                                            <a href="admin.edit.php?updateId='<?= $id; ?>'" class="text-light">Accept</a>
                                                            </button>
                                                       </td>
                                                  </tr>
                                             </tbody>
